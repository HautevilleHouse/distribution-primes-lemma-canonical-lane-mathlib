import DistributionPrimesLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "distribution primes lemma closure internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
